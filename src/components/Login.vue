                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block">
                                <img src="@/assets/image/logo2.jpg" width="100%">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
...
export default {
    ...
    methods : {
        login() {
            this.axios.post('http://localhost/projek_laundry/public/api/login', this.account).then(res => {
                if((res.data.success)) {
                    ...
                    this.$swal('Username atau Password anda salah!')
                }
            })
