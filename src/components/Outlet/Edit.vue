...
export default {
    ...
    created() {
        ...
        this.axios.get(`http://localhost/projek_laundry/public/api/outlet/${this.$route.params.id}`, {
    ...
    methods : {
        edit() {
            this.axios.put(`http://localhost/projek_laundry/public/api/outlet/${this.$route.params.id}`, this.outlet, {
                headers : { 'Authorization' : `Bearer` + this.$store.state.token }
            })
            .then( (res) => {
