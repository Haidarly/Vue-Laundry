...
export default {
    ...
    created() {
        ...
        this.axios.get(`http://localhost/projek_laundry/public/api/transaksi/${this.$route.params.id}`,
                        { 
                            headers: {Authorization : 'Bearer' + this.$store.state.token}
                        })
                    .then(res => {
    ...
    methods : {
        edit() {
            this.axios.post(`http://localhost/projek_laundry/public/api/transaksi/${this.transaksi.id}`,
