...
export default {
    ...
    created() {
        ...
        this.axios.get(`http://localhost/projek_laundry/public/api/user/${this.$route.params.id}`, {
        ...
        this.axios.get('http://localhost/projek_laundry/public/api/outlet', {
            headers : {'Authorization' : `Bearer` + this.$store.state.token}
        })
        .then( res => {
    ...
    methods : {
        edit() {
            this.axios.put(`http://localhost/projek_laundry/public/api/user/${this.$route.params.id}`, this.user, { headers : { 'Authorization' : `Bearer ` + this.$store.state.token} })
                      .then( (res) => {
                          if(res.data.success) {
